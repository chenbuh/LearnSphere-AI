import{R as T,r as $,s as x,a5 as A,ab as O,V as r,H as _,P as c,aj as q,K as o,ak as D,a7 as u,Q as f,al as X,am as H,an as K,ao as M,ap as Y,aq as U,T as I,ar as Z,Y as E,$ as N,as as G,q as J,a8 as Q,a1 as S,a2 as V,a3 as ee,at as te,J as ne,aa as ie,W,Z as ae,ac as oe,m as re}from"./index-Dy9YIUY0.js";import{g as le}from"./Tooltip-CFuMbi_-.js";import{f as se}from"./use-locale-C9scqsBf.js";import{u as ce}from"./use-houdini-D2dbk66m.js";const F=T({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const i=$(null),a=$(e.value),l=$(e.value),t=$("up"),n=$(!1),m=x(()=>n.value?`${e.clsPrefix}-base-slot-machine-current-number--${t.value}-scroll`:null),p=x(()=>n.value?`${e.clsPrefix}-base-slot-machine-old-number--${t.value}-scroll`:null);A(O(e,"value"),(s,d)=>{a.value=d,l.value=s,_(y)});function y(){const s=e.newOriginalNumber,d=e.oldOriginalNumber;d===void 0||s===void 0||(s>d?g("up"):d>s&&g("down"))}function g(s){t.value=s,n.value=!1,_(()=>{var d;(d=i.value)===null||d===void 0||d.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:s}=e;return r("span",{ref:i,class:`${s}-base-slot-machine-number`},a.value!==null?r("span",{class:[`${s}-base-slot-machine-old-number ${s}-base-slot-machine-old-number--top`,p.value]},a.value):null,r("span",{class:[`${s}-base-slot-machine-current-number`,m.value]},r("span",{ref:"numberWrapper",class:[`${s}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${s}-base-slot-machine-current-number__inner--not-number`]},l.value)),a.value!==null?r("span",{class:[`${s}-base-slot-machine-old-number ${s}-base-slot-machine-old-number--bottom`,p.value]},a.value):null)}}}),{cubicBezierEaseOut:C}=q;function me({duration:e=".2s"}={}){return[c("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${C},
 max-width ${e} ${C},
 transform ${e} ${C}
