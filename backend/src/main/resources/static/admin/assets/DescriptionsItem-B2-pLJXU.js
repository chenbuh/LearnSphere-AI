import{e as p,g as e,G as V,i as z,j as B,R as F,S as G,Z as H,$ as q,p as K,q as E,a0 as W,t as Z,w as D}from"./index-CgnLzOPV.js";import{g as J}from"./get-slot-Bk_rJcZu.js";import{u as Q}from"./use-compitable-Dsw3m3ey.js";import{m as L,h as n,d as T}from"./vue-core-D0hS1H_N.js";function M(t,g="default",d=[]){const{children:i}=t;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const s=i[g];if(typeof s=="function")return s()}return d}const U=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
 ...
 `))]),N="DESCRIPTION_ITEM_FLAG";function X(t){return typeof t=="object"&&t&&!Array.isArray(t)?t.type&&t.type[N]:!1}const Y=Object.assign(Object.assign({},E.props),{title:String,column:{type:Number,default:3},columns:Number,labelPlacement:{type:String,default:"top"},labelAlign:{type:String,default:"left"},separator:{type:String,default:":"},size:String,bordered:Boolean,labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]}),le=L({name:"Descriptions",props:Y,slots:Object,setup(t){const{mergedClsPrefixRef:g,inlineThemeDisabled:d,mergedComponentPropsRef:i}=K(t),s=T(()=>{var l,a;return t.size||((a=(l=i==null?void 0:i.value)===null||l===void 0?void 0:l.Descriptions)===null||a===void 0?void 0:a.size)||"medium"}),h=E("Descriptions","-descriptions",U,W,t,g),$=T(()=>{const{bordered:l}=t,a=s.value,{common:{cubicBezierEaseInOut:A},self:{titleTextColor:r,thColor:P,thColorModal:v,thColorPopover:R,thTextColor:I,thFontWeight:_,tdTextColor:j,tdColor:o,tdColorModal:f,tdColorPopover:O,borderColor:c,borderColorModal:m,borderColorPopover:y,borderRadius:w,lineHeight:u,[D("fontSize",a)]:S,[D(l?"thPaddingBordered":"thPadding",a)]:x,[D(l?"tdPaddingBordered":"tdPadding",a)]:C}}=h.value;return{"--n-title-text-color":r,"--n-th-padding":x,"--n-td-padding":C,"--n-font-size":S,"--n-bezier":A,"--n-th-font-weight":_,"--n-line-height":u,"--n-th-text-color":I,"--n-td-text-color":j,"--n-th-color":P,"--n-th-color-modal":v,"--n-th-color-popover":R,"--n-td-color":o,"--n-td-color-modal":f,"--n-td-color-popover":O,"--n-border-radius":w,"--n-border-color":c,"--n-border-color-modal":m,"--n-border-color-popover":y}}),b=d?Z("descriptions",T(()=>{let l="";const{bordered:a}=t;return a&&(l+="a"),l+=s.value[0],l}),$,t):void 0;return{mergedClsPrefix:g,cssVars:d?void 0:$,themeClass:b==null?void 0:b.themeClass,onRender:b==null?void 0:b.onRender,compitableColumn:Q(t,["columns","column"]),inlineThemeDisabled:d,mergedSize:s}},render(){const t=this.$slots.default,g=t?H(t()):[];g.length;const{contentClass:d,labelClass:i,compitableColumn:s,labelPlacement:h,labelAlign:$,mergedSize:b,bordered:l,title:a,cssVars:A,mergedClsPrefix:r,separator:P,onRender:v}=this;v==null||v();const R=g.filter(o=>X(o)),I={span:0,row:[],secondRow:[],rows:[]},j=R.reduce((o,f,O)=>{const c=f.props||{},m=R.length-1===O,y=["label"in c?c.label:M(f,"label")],w=[M(f)],u=c.span||1,S=o.span;o.span+=u;const x=c.labelStyle||c["label-style"]||this.labelStyle,C=c.contentStyle||c["content-style"]||this.contentStyle;if(h==="left")l?o.row.push(n("th",{class:[`${r}-descriptions-table-header`,i],colspan:1,style:x},y),n("td",{class:[`${r}-descriptions-table-content`,d],colspan:m?(s-S)*2+1:u*2-1,style:C},w)):o.row.push(n("td",{class:`${r}-descriptions-table-content`,colspan:m?(s-S)*2:u*2},n("span",{class:[`${r}-descriptions-table-content__label`,i],style:x},[...y,P&&n("span",{class:`${r}-descriptions-separator`},P)]),n("span",{class:[`${r}-descriptions-table-content__content`,d],style:C},w)));else{const k=m?(s-S)*2:u*2;o.row.push(n("th",{class:[`${r}-descriptions-table-header`,i],colspan:k,style:x},y)),o.secondRow.push(n("td",{class:[`${r}-descriptions-table-content`,d],colspan:k,style:C},w))}return(o.span>=s||m)&&(o.span=0,o.row.length&&(o.rows.push(o.row),o.row=[]),h!=="left"&&o.secondRow.length&&(o.rows.push(o.secondRow),o.secondRow=[])),o},I).rows.map(o=>n("tr",{class:`${r}-descriptions-table-row`},o));return n("div",{style:A,class:[`${r}-descriptions`,this.themeClass,`${r}-descriptions--${h}-label-placement`,`${r}-descriptions--${$}-label-align`,`${r}-descriptions--${b}-size`,l&&`${r}-descriptions--bordered`]},a||this.$slots.header?n("div",{class:`${r}-descriptions-header`},a||J(this,"header")):null,n("div",{class:`${r}-descriptions-table-wrapper`},n("table",{class:`${r}-descriptions-table`},n("tbody",null,h==="top"&&n("tr",{class:`${r}-descriptions-table-row`,style:{visibility:"collapse"}},q(s*2,n("td",null))),j))))}}),ee={label:String,span:{type:Number,default:1},labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]},ie=L({name:"DescriptionsItem",[N]:!0,props:ee,slots:Object,render(){return null}});export{le as N,ie as a};
