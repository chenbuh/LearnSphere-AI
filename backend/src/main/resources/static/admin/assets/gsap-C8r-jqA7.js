var k=(e,s,o)=>new Promise((i,n)=>{var t=a=>{try{d(o.next(a))}catch(c){n(c)}},r=a=>{try{d(o.throw(a))}catch(c){n(c)}},d=a=>a.done?i(a.value):Promise.resolve(a.value).then(t,r);d((o=o.apply(e,s)).next())});import{m as N,e as y,g as L,$ as O,p as A,q as P,w as H,M as _,_ as T}from"./index-CyjrJ4_E.js";import{m as $,h as z,y as j,F,d as S}from"./vue-core-D0hS1H_N.js";import{u as I}from"./use-houdini-BOU-9NEw.js";function M(e){const{heightSmall:s,heightMedium:o,heightLarge:i,borderRadius:n}=e;return{color:"#eee",colorEnd:"#ddd",borderRadius:n,heightSmall:s,heightMedium:o,heightLarge:i}}const V={common:N,self:M},q=y([L("skeleton",`
 height: 1em;
 width: 100%;
 transition:
