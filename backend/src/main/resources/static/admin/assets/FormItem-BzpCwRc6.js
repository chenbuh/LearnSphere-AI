import{Q as ge,g as S,i as y,e as D,p as le,q as ne,ar as be,as as ae,f as Pe,j as ee,H as Ie,at as se,t as Ce,au as ze,aq as de,w as A}from"./index-CgnLzOPV.js";import{l as K,g as Me,w as he,e as Le,m as ve,h as w,u as re,r as O,d as h,v as We,t as te,f as Ae}from"./vue-core-D0hS1H_N.js";import{Q as pe,S as fe}from"./vendor-DpTcvmEL.js";import{f as ie}from"./use-locale-Ci6bSOrz.js";function je(t,e,r){var n;const f=K(t,null);if(f===null)return;const l=(n=Me())===null||n===void 0?void 0:n.proxy;he(r,d),d(r.value),Le(()=>{d(void 0,r.value)});function d(i,a){if(!f)return;const s=f[e];a!==void 0&&g(s,a),i!==void 0&&b(s,i)}function g(i,a){i[a]||(i[a]=[]),i[a].splice(i[a].findIndex(s=>s===l),1)}function b(i,a){i[a]||(i[a]=[]),~i[a].findIndex(s=>s===l)||i[a].push(l)}}const Q=ge("n-form"),ke=ge("n-form-item-insts"),qe=S("form",[y("inline",`
 width: 100%;
 display: inline-flex;
