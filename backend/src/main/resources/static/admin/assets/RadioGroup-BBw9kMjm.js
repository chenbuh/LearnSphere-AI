...
`,[g("splitor",`
 ...
 `)])]);function ue(e,o,n){var d;const i=[];let f=!1;for(let s=0;s<e.length;++s){const l=e[s],u=(d=l.type)===null||d===void 0?void 0:d.name;u==="RadioButton"&&(f=!0);const h=l.props;if(u!=="RadioButton"){i.push(l);continue}if(s===0)i.push(l);else{const p=i[i.length-1].props,m=o===p.value,c=p.disabled,R=o===h.value,b=h.disabled,z=(m?2:0)+(c?0:1),y=(R?2:0)+(b?0:1),S={[`${n}-radio-group__splitor--disabled`]:c,[`${n}-radio-group__splitor--checked`]:m},w={[`${n}-radio-group__splitor--disabled`]:b,[`${n}-radio-group__splitor--checked`]:R},x=z<y?w:S;i.push(N("div",{class:[`${n}-radio-group__splitor`,x]}),l)}}return{children:i,isButtonGroup:f}}const ce=Object.assign(Object.assign({},A.props),{name:String,value:[String,Number,Boolean],defaultValue:{type:[String,Number,Boolean],default:null},size:String,disabled:{type:Boolean,default:void 0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array]}),me=ie({name:"RadioGroup",props:ce,setup(e){const o=k(null),{mergedSizeRef:n,mergedDisabledRef:d,nTriggerFormChange:i,nTriggerFormInput:f,nTriggerFormBlur:s,nTriggerFormFocus:l}=$(e),{mergedClsPrefixRef:u,inlineThemeDisabled:h,mergedRtlRef:p}=G(e),m=A("Radio","-radio-group",le,te,e,u),c=k(e.defaultValue),R=T(e,"value"),b=j(R,c);function z(r){const{onUpdateValue:a,"onUpdate:value":v}=e;a&&B(a,r),v&&B(v,r),c.value=r,i(),f()}function y(r){const{value:a}=o;a&&(a.contains(r.relatedTarget)||l())}function S(r){const{value:a}=o;a&&(a.contains(r.relatedTarget)||s())}de(H,{mergedClsPrefixRef:u,nameRef:T(e,"name"),valueRef:b,disabledRef:d,mergedSizeRef:n,doUpdateValue:z});const w=re("Radio",p,u),x=D(()=>{const{value:r}=n,{common:{cubicBezierEaseInOut:a},self:{buttonBorderColor:v,buttonBorderColorActive:F,buttonBorderRadius:I,buttonBoxShadow:K,buttonBoxShadowFocus:M,buttonBoxShadowHover:O,buttonColor:L,buttonColorActive:q,buttonTextColor:Q,buttonTextColorActive:W,buttonTextColorHover:Z,opacityDisabled:J,[P("buttonHeight",r)]:X,[P("fontSize",r)]:Y}}=m.value;return{"--n-font-size":Y,"--n-bezier":a,"--n-button-border-color":v,"--n-button-border-color-active":F,"--n-button-border-radius":I,"--n-button-box-shadow":K,"--n-button-box-shadow-focus":M,"--n-button-box-shadow-hover":O,"--n-button-color":L,"--n-button-color-active":q,"--n-button-text-color":Q,"--n-button-text-color-hover":Z,"--n-button-text-color-active":W,"--n-height":X,"--n-opacity-disabled":J}}),t=h?ne("radio-group",D(()=>n.value[0]),x,e):void 0;return{selfElRef:o,rtlEnabled:w,mergedClsPrefix:u,mergedValue:b,handleFocusout:S,handleFocusin:y,cssVars:h?void 0:x,themeClass:t==null?void 0:t.themeClass,onRender:t==null?void 0:t.onRender}},render(){var e;const{mergedValue:o,mergedClsPrefix:n,handleFocusin:d,handleFocusout:i}=this,{children:f,isButtonGroup:s}=ue(oe(se(this)),o,n);return(e=this.onRender)===null||e===void 0||e.call(this),N("div",{onFocusin:d,onFocusout:i,ref:"selfElRef",class:[`${n}-radio-group`,this.rtlEnabled&&`${n}-radio-group--rtl`,this.themeClass,s&&`${n}-radio-group--button-group`],style:this.cssVars},f)}});export{me as N,ge as r,pe as s};
