import{r as C,c as B,z as nt,d as ve,a as rt,h as u,D as nn,o as Ke,n as on,p as ln,u as Y,w as we,m as xt,A as St,E as Ct,F as rn,y as an,I as sn,J as dn}from"./vue-core-k66yWm0l.js";import{D as ye,aH as ut,aI as un,aE as ot,$ as _e,aJ as Ye,aK as Fe,i as cn,e as P,g as V,f as oe,h as se,t as lt,al as Rt,r as ct,aF as fn,S as hn,F as vn,l as at,w as Ft,m as Te,aL as gn,v as me,aB as $e,n as st,aM as bn,aN as pn,aO as ft,aP as mn,C as wn,am as yn,aQ as xn,aR as Sn,o as ae}from"./index-DahIAh76.js";import{i as dt,b as Cn,N as Rn,B as Fn,V as Tn,a as On,u as it}from"./Popover-DLi66xIH.js";import{a as Mn}from"./Input-DnsJRt06.js";import{N as Je}from"./Tag-BCMARYeD.js";import{V as ht}from"./index-k4lpeCHj.js";import{g as vt}from"./attribute-Cz32yFEB.js";import{F as In}from"./Checkmark-D6iJmL7_.js";import{c as Qe,a as zn}from"./cssr-D4Wn-_UV.js";import{b as kn}from"./next-frame-once-C5Ksf8W7.js";import{a as Pn,h as Ee,c as Bn}from"./create-D3Vn69pI.js";import{N as _n}from"./Empty-B86ET1iS.js";import{u as gt}from"./use-merged-state-DCOVafah.js";import{u as $n}from"./use-compitable-C8LpTH9g.js";import{u as En}from"./use-locale-B2J8zvEP.js";function bt(e){return e&-e}class Tt{constructor(n,o){this.l=n,this.min=o;const l=new Array(n+1);for(let i=0;i<n+1;++i)l[i]=0;this.ft=l}add(n,o){if(o===0)return;const{l,ft:i}=this;for(n+=1;n<=l;)i[n]+=o,n+=bt(n)}get(n){return this.sum(n+1)-this.sum(n)}sum(n){if(n===void 0&&(n=this.l),n<=0)return 0;const{ft:o,min:l,l:i}=this;if(n>i)throw new Error("[FinweckTree.sum]: `i` is larger than length.");let f=n*l;for(;n>0;)f+=o[n],n-=bt(n);return f}getBound(n){let o=0,l=this.l;for(;l>o;){const i=Math.floor((o+l)/2),f=this.sum(i);if(f>n){l=i;continue}else if(f<n){if(o===i)return this.sum(o+1)<=n?o+1:i;o=i}else return i}return o}}let je;function Nn(){return typeof document=="undefined"?!1:(je===void 0&&("matchMedia"in window?je=window.matchMedia("(pointer:coarse)").matches:je=!1),je)}let Ze;function pt(){return typeof document=="undefined"?1:(Ze===void 0&&(Ze="chrome"in window?window.devicePixelRatio:1),Ze)}const Ot="VVirtualListXScroll";function An({columnsRef:e,renderColRef:n,renderItemWithColsRef:o}){const l=C(0),i=C(0),f=B(()=>{const m=e.value;if(m.length===0)return null;const w=new Tt(m.length,0);return m.forEach((_,R)=>{w.add(R,_.width)}),w}),v=ye(()=>{const m=f.value;return m!==null?Math.max(m.getBound(i.value)-1,0):0}),d=m=>{const w=f.value;return w!==null?w.sum(m):0},p=ye(()=>{const m=f.value;return m!==null?Math.min(m.getBound(i.value+l.value)+1,e.value.length-1):0});return nt(Ot,{startIndexRef:v,endIndexRef:p,columnsRef:e,renderColRef:n,renderItemWithColsRef:o,getLeft:d}),{listWidthRef:l,scrollLeftRef:i}}const mt=ve({name:"VirtualListRow",props:{index:{type:Number,required:!0},item:{type:Object,required:!0}},setup(){const{startIndexRef:e,endIndexRef:n,columnsRef:o,getLeft:l,renderColRef:i,renderItemWithColsRef:f}=rt(Ot);return{startIndex:e,endIndex:n,columns:o,renderCol:i,renderItemWithCols:f,getLeft:l}},render(){const{startIndex:e,endIndex:n,columns:o,renderCol:l,renderItemWithCols:i,getLeft:f,item:v}=this;if(i!=null)return i({itemIndex:this.index,startColIndex:e,endColIndex:n,allColumns:o,item:v,getLeft:f});if(l!=null){const d=[];for(let p=e;p<=n;++p){const m=o[p];d.push(l({column:m,left:f(p),item:v}))}return d}return null}}),Ln=Qe(".v-vl",{maxHeight:"inherit",height:"100%",overflow:"auto",minWidth:"1px"},[Qe("&:not(.v-vl--show-scrollbar)",{scrollbarWidth:"none"},[Qe("&::-webkit-scrollbar, &::-webkit-scrollbar-track-piece, &::-webkit-scrollbar-thumb",{width:0,height:0,display:"none"})])]),Dn=ve({name:"VirtualList",inheritAttrs:!1,props:{showScrollbar:{type:Boolean,default:!0},columns:{type:Array,default:()=>[]},renderCol:Function,renderItemWithCols:Function,items:{type:Array,default:()=>[]},itemSize:{type:Number,required:!0},itemResizable:Boolean,itemsStyle:[String,Object],visibleItemsTag:{type:[String,Object],default:"div"},visibleItemsProps:Object,ignoreItemResize:Boolean,onScroll:Function,onWheel:Function,onResize:Function,defaultScrollKey:[Number,String],defaultScrollIndex:Number,keyField:{type:String,default:"key"},paddingTop:{type:[Number,String],default:0},paddingBottom:{type:[Number,String],default:0}},setup(e){const n=un();Ln.mount({id:"vueuc/virtual-list",head:!0,anchorMetaName:zn,ssr:n}),Ke(()=>{const{defaultScrollIndex:a,defaultScrollKey:b}=e;a!=null?q({index:a}):b!=null&&q({key:b})});let o=!1,l=!1;on(()=>{if(o=!1,!l){l=!0;return}q({top:x.value,left:v.value})}),ln(()=>{o=!0,l||(l=!0)});const i=ye(()=>{if(e.renderCol==null&&e.renderItemWithCols==null||e.columns.length===0)return;let a=0;return e.columns.forEach(b=>{a+=b.width}),a}),f=B(()=>{const a=new Map,{keyField:b}=e;return e.items.forEach((z,N)=>{a.set(z[b],N)}),a}),{scrollLeftRef:v,listWidthRef:d}=An({columnsRef:Y(e,"columns"),renderColRef:Y(e,"renderCol"),renderItemWithColsRef:Y(e,"renderItemWithCols")}),p=C(null),m=C(void 0),w=new Map,_=B(()=>{const{items:a,itemSize:b,keyField:z}=e,N=new Tt(a.length,b);return a.forEach((K,L)=>{const D=K[z],$=w.get(D);$!==void 0&&N.add(L,$)}),N}),R=C(0),x=C(0),S=ye(()=>Math.max(_.value.getBound(x.value-ot(e.paddingTop))-1,0)),j=B(()=>{const{value:a}=m;if(a===void 0)return[];const{items:b,itemSize:z}=e,N=S.value,K=Math.min(N+Math.ceil(a/z+1),b.length-1),L=[];for(let D=N;D<=K;++D)L.push(b[D]);return L}),q=(a,b)=>{if(typeof a=="number"){W(a,b,"auto");return}const{left:z,top:N,index:K,key:L,position:D,behavior:$,debounce:G=!0}=a;if(z!==void 0||N!==void 0)W(z,N,$);else if(K!==void 0)A(K,$,G);else if(L!==void 0){const s=f.value.get(L);s!==void 0&&A(s,$,G)}else D==="bottom"?W(0,Number.MAX_SAFE_INTEGER,$):D==="top"&&W(0,0,$)};let I,T=null;function A(a,b,z){const{value:N}=_,K=N.sum(a)+ot(e.paddingTop);if(!z)p.value.scrollTo({left:0,top:K,behavior:b});else{I=a,T!==null&&window.clearTimeout(T),T=window.setTimeout(()=>{I=void 0,T=null},16);const{scrollTop:L,offsetHeight:D}=p.value;if(K>L){const $=N.get(a);K+$<=L+D||p.value.scrollTo({left:0,top:K+$-D,behavior:b})}else p.value.scrollTo({left:0,top:K,behavior:b})}}function W(a,b,z){p.value.scrollTo({left:a,top:b,behavior:z})}function H(a,b){var z,N,K;if(o||e.ignoreItemResize||ie(b.target))return;const{value:L}=_,D=f.value.get(a),$=L.get(D),G=(K=(N=(z=b.borderBoxSize)===null||z===void 0?void 0:z[0])===null||N===void 0?void 0:N.blockSize)!==null&&K!==void 0?K:b.contentRect.height;if(G===$)return;G-e.itemSize===0?w.delete(a):w.set(a,G-e.itemSize);const h=G-$;if(h===0)return;L.add(D,h);const E=p.value;if(E!=null){if(I===void 0){const te=L.sum(D);E.scrollTop>te&&E.scrollBy(0,h)}else if(D<I)E.scrollBy(0,h);else if(D===I){const te=L.sum(D);G+te>E.scrollTop+E.offsetHeight&&E.scrollBy(0,h)}ee()}R.value++}const Z=!Nn();let J=!1;function de(a){var b;(b=e.onScroll)===null||b===void 0||b.call(e,a),(!Z||!J)&&ee()}function ue(a){var b;if((b=e.onWheel)===null||b===void 0||b.call(e,a),Z){const z=p.value;if(z!=null){if(a.deltaX===0&&(z.scrollTop===0&&a.deltaY<=0||z.scrollTop+z.offsetHeight>=z.scrollHeight&&a.deltaY>=0))return;a.preventDefault(),z.scrollTop+=a.deltaY/pt(),z.scrollLeft+=a.deltaX/pt(),ee(),J=!0,kn(()=>{J=!1})}}}function le(a){if(o||ie(a.target))return;if(e.renderCol==null&&e.renderItemWithCols==null){if(a.contentRect.height===m.value)return}else if(a.contentRect.height===m.value&&a.contentRect.width===d.value)return;m.value=a.contentRect.height,d.value=a.contentRect.width;const{onResize:b}=e;b!==void 0&&b(a)}function ee(){const{value:a}=p;a!=null&&(x.value=a.scrollTop,v.value=a.scrollLeft)}function ie(a){let b=a;for(;b!==null;){if(b.style.display==="none")return!0;b=b.parentElement}return!1}return{listHeight:m,listStyle:{overflow:"auto"},keyToIndex:f,itemsStyle:B(()=>{const{itemResizable:a}=e,b=_e(_.value.sum());return R.value,[e.itemsStyle,{boxSizing:"content-box",width:_e(i.value),height:a?"":b,minHeight:a?b:"",paddingTop:_e(e.paddingTop),paddingBottom:_e(e.paddingBottom)}]}),visibleItemsStyle:B(()=>(R.value,{transform:`translateY(${_e(_.value.sum(S.value))})`})),viewportItems:j,listElRef:p,itemsElRef:C(null),scrollTo:q,handleListResize:le,handleListScroll:de,handleListWheel:ue,handleItemResize:H}},render(){const{itemResizable:e,keyField:n,keyToIndex:o,visibleItemsTag:l}=this;return u(ut,{onResize:this.handleListResize},{default:()=>{var i,f;return u("div",nn(this.$attrs,{class:["v-vl",this.showScrollbar&&"v-vl--show-scrollbar"],onScroll:this.handleListScroll,onWheel:this.handleListWheel,ref:"listElRef"}),[this.items.length!==0?u("div",{ref:"itemsElRef",class:"v-vl-items",style:this.itemsStyle},[u(l,Object.assign({class:"v-vl-visible-items",style:this.visibleItemsStyle},this.visibleItemsProps),{default:()=>{const{renderCol:v,renderItemWithCols:d}=this;return this.viewportItems.map(p=>{const m=p[n],w=o.get(m),_=v!=null?u(mt,{index:w,item:p}):void 0,R=d!=null?u(mt,{index:w,item:p}):void 0,x=this.$slots.default({item:p,renderedCols:_,renderedItemWithCols:R,index:w})[0];return e?u(ut,{key:m,onResize:S=>this.handleItemResize(m,S)},{default:()=>x}):(x.key=m,x)})}})]):(f=(i=this.$slots).empty)===null||f===void 0?void 0:f.call(i)])}})}});function Mt(e,n){n&&(Ke(()=>{const{value:o}=e;o&&Ye.registerHandler(o,n)}),we(e,(o,l)=>{l&&Ye.unregisterHandler(l)},{deep:!1}),xt(()=>{const{value:o}=e;o&&Ye.unregisterHandler(o)}))}function et(e){const n=e.filter(o=>o!==void 0);if(n.length!==0)return n.length===1?n[0]:o=>{e.forEach(l=>{l&&l(o)})}}const Vn=ve({props:{onFocus:Function,onBlur:Function},setup(e){return()=>u("div",{style:"width: 0; height: 0",tabindex:0,onFocus:e.onFocus,onBlur:e.onBlur})}}),wt=ve({name:"NBaseSelectGroupHeader",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(){const{renderLabelRef:e,renderOptionRef:n,labelFieldRef:o,nodePropsRef:l}=rt(dt);return{labelField:o,nodeProps:l,renderLabel:e,renderOption:n}},render(){const{clsPrefix:e,renderLabel:n,renderOption:o,nodeProps:l,tmNode:{rawNode:i}}=this,f=l==null?void 0:l(i),v=n?n(i,!1):Fe(i[this.labelField],i,!1),d=u("div",Object.assign({},f,{class:[`${e}-base-select-group-header`,f==null?void 0:f.class]}),v);return i.render?i.render({node:d,option:i}):o?o({node:d,option:i,selected:!1}):d}});function Wn(e,n){return u(St,{name:"fade-in-scale-up-transition"},{default:()=>e?u(cn,{clsPrefix:n,class:`${n}-base-select-option__check`},{default:()=>u(In)}):null})}const yt=ve({name:"NBaseSelectOption",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(e){const{valueRef:n,pendingTmNodeRef:o,multipleRef:l,valueSetRef:i,renderLabelRef:f,renderOptionRef:v,labelFieldRef:d,valueFieldRef:p,showCheckmarkRef:m,nodePropsRef:w,handleOptionClick:_,handleOptionMouseEnter:R}=rt(dt),x=ye(()=>{const{value:I}=o;return I?e.tmNode.key===I.key:!1});function S(I){const{tmNode:T}=e;T.disabled||_(I,T)}function j(I){const{tmNode:T}=e;T.disabled||R(I,T)}function q(I){const{tmNode:T}=e,{value:A}=x;T.disabled||A||R(I,T)}return{multiple:l,isGrouped:ye(()=>{const{tmNode:I}=e,{parent:T}=I;return T&&T.rawNode.type==="group"}),showCheckmark:m,nodeProps:w,isPending:x,isSelected:ye(()=>{const{value:I}=n,{value:T}=l;if(I===null)return!1;const A=e.tmNode.rawNode[p.value];if(T){const{value:W}=i;return W.has(A)}else return I===A}),labelField:d,renderLabel:f,renderOption:v,handleMouseMove:q,handleMouseEnter:j,handleClick:S}},render(){const{clsPrefix:e,tmNode:{rawNode:n},isSelected:o,isPending:l,isGrouped:i,showCheckmark:f,nodeProps:v,renderOption:d,renderLabel:p,handleClick:m,handleMouseEnter:w,handleMouseMove:_}=this,R=Wn(o,e),x=p?[p(n,o),f&&R]:[Fe(n[this.labelField],n,o),f&&R],S=v==null?void 0:v(n),j=u("div",Object.assign({},S,{class:[`${e}-base-select-option`,n.class,S==null?void 0:S.class,{[`${e}-base-select-option--disabled`]:n.disabled,[`${e}-base-select-option--selected`]:o,[`${e}-base-select-option--grouped`]:i,[`${e}-base-select-option--pending`]:l,[`${e}-base-select-option--show-checkmark`]:f}],style:[(S==null?void 0:S.style)||"",n.style||""],onClick:et([m,S==null?void 0:S.onClick]),onMouseenter:et([w,S==null?void 0:S.onMouseenter]),onMousemove:et([_,S==null?void 0:S.onMousemove])}),u("div",{class:`${e}-base-select-option__content`},x));return n.render?n.render({node:j,option:n,selected:o}):d?d({node:j,option:n,selected:o}):j}}),jn=P("base-select-menu",`
 line-height: 1.5;
 outline: none;
 z-index: 0;
 position: relative;
