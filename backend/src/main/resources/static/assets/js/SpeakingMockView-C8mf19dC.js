var de=(l,d,D)=>new Promise((C,p)=>{var y=_=>{try{T(D.next(_))}catch(U){p(U)}},K=_=>{try{T(D.throw(_))}catch(U){p(U)}},T=_=>_.done?C(_.value):Promise.resolve(_.value).then(y,K);T((D=D.apply(l,d)).next())});import{a8 as xt,d as yt,h as R,z as kt,r as x,w as je,D as Ce,m as _t,u as St,c as Y,o as Ct,b as zt,N as Tt,Q as b,X as k,Y as o,f as i,P as h,M as r,q as N,Z as A,a1 as Ne,O as De,F as Z,$ as ee,J as $e,a0 as Vt,a9 as Mt,a2 as Rt}from"./vue-core-Qok9l9dg.js";import{b as Ae}from"./utils-xYuYZ4Xr.js";import{a as xe}from"./ai-DXMukmk2.js";import{A as Nt,a9 as Dt,h as ce,e as c,f as E,g as ye,aa as Pe,ab as $t,ac as At,E as It,l as Bt,m as Ze,C as Ft,n as Le,ad as Et,o as ke,F as _e,ae as Se,d as Ut,a2 as Ht,u as jt,B as W,N as Pt,a as Ie,b as Lt}from"./index-kvCe5h5c.js";import{u as Ot}from"./useTextAudio-BShkqbSt.js";import{e as Wt,i as Kt,M as Xt,V as qt}from"./voskSpeechRecognizer-BjnKOesp.js";import{_ as Yt}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{aa as Oe,F as Qt,V as Gt,al as Jt,aj as We,am as Zt,U as ea,h as Ke,an as ta,t as Xe,I as aa,C as oa,a7 as sa}from"./icons-FSQdP13O.js";import{N as na}from"./Tooltip-DoF_dn7L.js";import{B as la,V as ra,a as ia,u as Fe}from"./Popover-DMUJDzmp.js";import{u as da}from"./use-merged-state-3vwOMuut.js";import{S as ca}from"./Scrollbar-fUW1m0-h.js";import{N as ua}from"./NumberAnimation-BaY_Ndzs.js";import{N as Be}from"./Space-CJvz8-6w.js";import{N as fa}from"./Tag-CHjg5cnQ.js";import{N as qe}from"./Avatar-B5Hih_Bu.js";import{N as va}from"./Input-w4O6pf6s.js";import{N as ha}from"./Empty-Q9jZEl6Q.js";import{N as Ye}from"./Spin-BSbpr_FI.js";import{N as Qe}from"./Progress-CVo3aazv.js";import{N as ma}from"./Divider-kZkGWOuO.js";import"./vendor-CcVv25CF.js";import"./cssr-DD0yHMfF.js";import"./next-frame-once-C5Ksf8W7.js";import"./use-compitable-CoNRZgmE.js";import"./use-locale-BQCI0foI.js";import"./get-slot-Bk_rJcZu.js";import"./Suffix-n6QzidAU.js";function pa(l){const d="rgba(0, 0, 0, .85)",D="0 2px 8px 0 rgba(0, 0, 0, 0.12)",{railColor:C,primaryColor:p,baseColor:y,cardColor:K,modalColor:T,popoverColor:_,borderRadius:U,fontSize:G,opacityDisabled:Q}=l;return Object.assign(Object.assign({},Dt),{fontSize:G,markFontSize:G,railColor:C,railColorHover:C,fillColor:p,fillColorHover:p,opacityDisabled:Q,handleColor:"#FFF",dotColor:K,dotColorModal:T,dotColorPopover:_,handleBoxShadow:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowHover:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowActive:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowFocus:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",indicatorColor:d,indicatorBoxShadow:D,indicatorTextColor:y,indicatorBorderRadius:U,dotBorder:`2px solid ${C}`,dotBorderActive:`2px solid ${p}`,dotBoxShadow:""})}const ga={common:Nt,self:pa},ba=ce([c("slider",`
 display: block;
