import{c as B,r as F,y as ot,d as be,a as at,h as c,B as nn,o as Ke,n as on,p as ln,u as J,w as ye,m as St,z as Ct,D as Rt,F as rn,j as an,H as sn,I as dn}from"./vue-core-Qok9l9dg.js";import{D as xe,aG as ct,aD as un,at as lt,as as _e,bm as Je,aE as Te,i as cn,e as k,g as L,f as ie,h as ue,t as it,aa as Ft,r as ft,ar as fn,S as hn,E as vn,l as st,v as Tt,m as Oe,bn as gn,n as dt,w as we,aI as $e,bo as bn,bp as pn,aN as ht,bq as mn,C as wn,ad as yn,b7 as xn,br as Sn,o as de}from"./index-DWq0_FoP.js";import{i as ut,b as Cn,N as Rn,B as Fn,V as Tn,a as On,u as rt}from"./Popover-BBNE_ZHP.js";import{a as Mn}from"./Suffix-wo5bWPcj.js";import{N as Qe}from"./Tag-Bz8Q9YAP.js";import{V as vt}from"./index-BWJJgTLr.js";import{g as gt}from"./attribute-Cz32yFEB.js";import{F as zn}from"./Checkmark-BYmAJhYq.js";import{c as In,a as Ze}from"./cssr-CRQrCRnn.js";import{b as Pn}from"./next-frame-once-C5Ksf8W7.js";import{N as kn}from"./Empty-DrmdyfSY.js";import{h as Ee,a as Bn,c as _n}from"./create-D3Vn69pI.js";import{u as bt}from"./use-merged-state-3vwOMuut.js";import{u as $n}from"./use-locale-DXGQ8vop.js";import{u as En}from"./use-compitable-CoNRZgmE.js";function pt(e){return e&-e}class Ot{constructor(n,o){this.l=n,this.min=o;const l=new Array(n+1);for(let a=0;a<n+1;++a)l[a]=0;this.ft=l}add(n,o){if(o===0)return;const{l,ft:a}=this;for(n+=1;n<=l;)a[n]+=o,n+=pt(n)}get(n){return this.sum(n+1)-this.sum(n)}sum(n){if(n===void 0&&(n=this.l),n<=0)return 0;const{ft:o,min:l,l:a}=this;if(n>a)throw new Error("[FinweckTree.sum]: `i` is larger than length.");let f=n*l;for(;n>0;)f+=o[n],n-=pt(n);return f}getBound(n){let o=0,l=this.l;for(;l>o;){const a=Math.floor((o+l)/2),f=this.sum(a);if(f>n){l=a;continue}else if(f<n){if(o===a)return this.sum(o+1)<=n?o+1:a;o=a}else return a}return o}}let je;function Nn(){return typeof document=="undefined"?!1:(je===void 0&&("matchMedia"in window?je=window.matchMedia("(pointer:coarse)").matches:je=!1),je)}let et;function mt(){return typeof document=="undefined"?1:(et===void 0&&(et="chrome"in window?window.devicePixelRatio:1),et)}const Mt="VVirtualListXScroll";function An({columnsRef:e,renderColRef:n,renderItemWithColsRef:o}){const l=F(0),a=F(0),f=B(()=>{const w=e.value;if(w.length===0)return null;const T=new Ot(w.length,0);return w.forEach((S,_)=>{T.add(_,S.width)}),T}),g=xe(()=>{const w=f.value;return w!==null?Math.max(w.getBound(a.value)-1,0):0}),d=w=>{const T=f.value;return T!==null?T.sum(w):0},y=xe(()=>{const w=f.value;return w!==null?Math.min(w.getBound(a.value+l.value)+1,e.value.length-1):0});return ot(Mt,{startIndexRef:g,endIndexRef:y,columnsRef:e,renderColRef:n,renderItemWithColsRef:o,getLeft:d}),{listWidthRef:l,scrollLeftRef:a}}const wt=be({name:"VirtualListRow",props:{index:{type:Number,required:!0},item:{type:Object,required:!0}},setup(){const{startIndexRef:e,endIndexRef:n,columnsRef:o,getLeft:l,renderColRef:a,renderItemWithColsRef:f}=at(Mt);return{startIndex:e,endIndex:n,columns:o,renderCol:a,renderItemWithCols:f,getLeft:l}},render(){const{startIndex:e,endIndex:n,columns:o,renderCol:l,renderItemWithCols:a,getLeft:f,item:g}=this;if(a!=null)return a({itemIndex:this.index,startColIndex:e,endColIndex:n,allColumns:o,item:g,getLeft:f});if(l!=null){const d=[];for(let y=e;y<=n;++y){const w=o[y];d.push(l({column:w,left:f(y),item:g}))}return d}return null}}),Ln=Ze(".v-vl",{maxHeight:"inherit",height:"100%",overflow:"auto",minWidth:"1px"},[Ze("&:not(.v-vl--show-scrollbar)",{scrollbarWidth:"none"},[Ze("&::-webkit-scrollbar, &::-webkit-scrollbar-track-piece, &::-webkit-scrollbar-thumb",{width:0,height:0,display:"none"})])]),Dn=be({name:"VirtualList",inheritAttrs:!1,props:{showScrollbar:{type:Boolean,default:!0},columns:{type:Array,default:()=>[]},renderCol:Function,renderItemWithCols:Function,items:{type:Array,default:()=>[]},itemSize:{type:Number,required:!0},itemResizable:Boolean,itemsStyle:[String,Object],visibleItemsTag:{type:[String,Object],default:"div"},visibleItemsProps:Object,ignoreItemResize:Boolean,onScroll:Function,onWheel:Function,onResize:Function,defaultScrollKey:[Number,String],defaultScrollIndex:Number,keyField:{type:String,default:"key"},paddingTop:{type:[Number,String],default:0},paddingBottom:{type:[Number,String],default:0}},setup(e){const n=un();Ln.mount({id:"vueuc/virtual-list",head:!0,anchorMetaName:In,ssr:n}),Ke(()=>{const{defaultScrollIndex:s,defaultScrollKey:b}=e;s!=null?G({index:s}):b!=null&&G({key:b})});let o=!1,l=!1;on(()=>{if(o=!1,!l){l=!0;return}G({top:O.value,left:g.value})}),ln(()=>{o=!0,l||(l=!0)});const a=xe(()=>{if(e.renderCol==null&&e.renderItemWithCols==null||e.columns.length===0)return;let s=0;return e.columns.forEach(b=>{s+=b.width}),s}),f=B(()=>{const s=new Map,{keyField:b}=e;return e.items.forEach((P,$)=>{s.set(P[b],$)}),s}),{scrollLeftRef:g,listWidthRef:d}=An({columnsRef:J(e,"columns"),renderColRef:J(e,"renderCol"),renderItemWithColsRef:J(e,"renderItemWithCols")}),y=F(null),w=F(void 0),T=new Map,S=B(()=>{const{items:s,itemSize:b,keyField:P}=e,$=new Ot(s.length,b);return s.forEach((N,K)=>{const E=N[P],j=T.get(E);j!==void 0&&$.add(K,j)}),$}),_=F(0),O=F(0),p=xe(()=>Math.max(S.value.getBound(O.value-lt(e.paddingTop))-1,0)),A=B(()=>{const{value:s}=w;if(s===void 0)return[];const{items:b,itemSize:P}=e,$=p.value,N=Math.min($+Math.ceil(s/P+1),b.length-1),K=[];for(let E=$;E<=N;++E)K.push(b[E]);return K}),G=(s,b)=>{if(typeof s=="number"){Y(s,b,"auto");return}const{left:P,top:$,index:N,key:K,position:E,behavior:j,debounce:H=!0}=s;if(P!==void 0||$!==void 0)Y(P,$,j);else if(N!==void 0)V(N,j,H);else if(K!==void 0){const Z=f.value.get(K);Z!==void 0&&V(Z,j,H)}else E==="bottom"?Y(0,Number.MAX_SAFE_INTEGER,j):E==="top"&&Y(0,0,j)};let z,I=null;function V(s,b,P){const{value:$}=S,N=$.sum(s)+lt(e.paddingTop);if(!P)y.value.scrollTo({left:0,top:N,behavior:b});else{z=s,I!==null&&window.clearTimeout(I),I=window.setTimeout(()=>{z=void 0,I=null},16);const{scrollTop:K,offsetHeight:E}=y.value;if(N>K){const j=$.get(s);N+j<=K+E||y.value.scrollTo({left:0,top:N+j-E,behavior:b})}else y.value.scrollTo({left:0,top:N,behavior:b})}}function Y(s,b,P){y.value.scrollTo({left:s,top:b,behavior:P})}function W(s,b){var P,$,N;if(o||e.ignoreItemResize||ee(b.target))return;const{value:K}=S,E=f.value.get(s),j=K.get(E),H=(N=($=(P=b.borderBoxSize)===null||P===void 0?void 0:P[0])===null||$===void 0?void 0:$.blockSize)!==null&&N!==void 0?N:b.contentRect.height;if(H===j)return;H-e.itemSize===0?T.delete(s):T.set(s,H-e.itemSize);const oe=H-j;if(oe===0)return;K.add(E,oe);const i=y.value;if(i!=null){if(z===void 0){const h=K.sum(E);i.scrollTop>h&&i.scrollBy(0,oe)}else if(E<z)i.scrollBy(0,oe);else if(E===z){const h=K.sum(E);H+h>i.scrollTop+i.offsetHeight&&i.scrollBy(0,oe)}Q()}_.value++}const D=!Nn();let te=!1;function ne(s){var b;(b=e.onScroll)===null||b===void 0||b.call(e,s),(!D||!te)&&Q()}function ce(s){var b;if((b=e.onWheel)===null||b===void 0||b.call(e,s),D){const P=y.value;if(P!=null){if(s.deltaX===0&&(P.scrollTop===0&&s.deltaY<=0||P.scrollTop+P.offsetHeight>=P.scrollHeight&&s.deltaY>=0))return;s.preventDefault(),P.scrollTop+=s.deltaY/mt(),P.scrollLeft+=s.deltaX/mt(),Q(),te=!0,Pn(()=>{te=!1})}}}function he(s){if(o||ee(s.target))return;if(e.renderCol==null&&e.renderItemWithCols==null){if(s.contentRect.height===w.value)return}else if(s.contentRect.height===w.value&&s.contentRect.width===d.value)return;w.value=s.contentRect.height,d.value=s.contentRect.width;const{onResize:b}=e;b!==void 0&&b(s)}function Q(){const{value:s}=y;s!=null&&(O.value=s.scrollTop,g.value=s.scrollLeft)}function ee(s){let b=s;for(;b!==null;){if(b.style.display==="none")return!0;b=b.parentElement}return!1}return{listHeight:w,listStyle:{overflow:"auto"},keyToIndex:f,itemsStyle:B(()=>{const{itemResizable:s}=e,b=_e(S.value.sum());return _.value,[e.itemsStyle,{boxSizing:"content-box",width:_e(a.value),height:s?"":b,minHeight:s?b:"",paddingTop:_e(e.paddingTop),paddingBottom:_e(e.paddingBottom)}]}),visibleItemsStyle:B(()=>(_.value,{transform:`translateY(${_e(S.value.sum(p.value))})`})),viewportItems:A,listElRef:y,itemsElRef:F(null),scrollTo:G,handleListResize:he,handleListScroll:ne,handleListWheel:ce,handleItemResize:W}},render(){const{itemResizable:e,keyField:n,keyToIndex:o,visibleItemsTag:l}=this;return c(ct,{onResize:this.handleListResize},{default:()=>{var a,f;return c("div",nn(this.$attrs,{class:["v-vl",this.showScrollbar&&"v-vl--show-scrollbar"],onScroll:this.handleListScroll,onWheel:this.handleListWheel,ref:"listElRef"}),[this.items.length!==0?c("div",{ref:"itemsElRef",class:"v-vl-items",style:this.itemsStyle},[c(l,Object.assign({class:"v-vl-visible-items",style:this.visibleItemsStyle},this.visibleItemsProps),{default:()=>{const{renderCol:g,renderItemWithCols:d}=this;return this.viewportItems.map(y=>{const w=y[n],T=o.get(w),S=g!=null?c(wt,{index:T,item:y}):void 0,_=d!=null?c(wt,{index:T,item:y}):void 0,O=this.$slots.default({item:y,renderedCols:S,renderedItemWithCols:_,index:T})[0];return e?c(ct,{key:w,onResize:p=>this.handleItemResize(w,p)},{default:()=>O}):(O.key=w,O)})}})]):(f=(a=this.$slots).empty)===null||f===void 0?void 0:f.call(a)])}})}});function zt(e,n){n&&(Ke(()=>{const{value:o}=e;o&&Je.registerHandler(o,n)}),ye(e,(o,l)=>{l&&Je.unregisterHandler(l)},{deep:!1}),St(()=>{const{value:o}=e;o&&Je.unregisterHandler(o)}))}function tt(e){const n=e.filter(o=>o!==void 0);if(n.length!==0)return n.length===1?n[0]:o=>{e.forEach(l=>{l&&l(o)})}}const Vn=be({props:{onFocus:Function,onBlur:Function},setup(e){return()=>c("div",{style:"width: 0; height: 0",tabindex:0,onFocus:e.onFocus,onBlur:e.onBlur})}}),yt=be({name:"NBaseSelectGroupHeader",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(){const{renderLabelRef:e,renderOptionRef:n,labelFieldRef:o,nodePropsRef:l}=at(ut);return{labelField:o,nodeProps:l,renderLabel:e,renderOption:n}},render(){const{clsPrefix:e,renderLabel:n,renderOption:o,nodeProps:l,tmNode:{rawNode:a}}=this,f=l==null?void 0:l(a),g=n?n(a,!1):Te(a[this.labelField],a,!1),d=c("div",Object.assign({},f,{class:[`${e}-base-select-group-header`,f==null?void 0:f.class]}),g);return a.render?a.render({node:d,option:a}):o?o({node:d,option:a,selected:!1}):d}});function Wn(e,n){return c(Ct,{name:"fade-in-scale-up-transition"},{default:()=>e?c(cn,{clsPrefix:n,class:`${n}-base-select-option__check`},{default:()=>c(zn)}):null})}const xt=be({name:"NBaseSelectOption",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(e){const{valueRef:n,pendingTmNodeRef:o,multipleRef:l,valueSetRef:a,renderLabelRef:f,renderOptionRef:g,labelFieldRef:d,valueFieldRef:y,showCheckmarkRef:w,nodePropsRef:T,handleOptionClick:S,handleOptionMouseEnter:_}=at(ut),O=xe(()=>{const{value:z}=o;return z?e.tmNode.key===z.key:!1});function p(z){const{tmNode:I}=e;I.disabled||S(z,I)}function A(z){const{tmNode:I}=e;I.disabled||_(z,I)}function G(z){const{tmNode:I}=e,{value:V}=O;I.disabled||V||_(z,I)}return{multiple:l,isGrouped:xe(()=>{const{tmNode:z}=e,{parent:I}=z;return I&&I.rawNode.type==="group"}),showCheckmark:w,nodeProps:T,isPending:O,isSelected:xe(()=>{const{value:z}=n,{value:I}=l;if(z===null)return!1;const V=e.tmNode.rawNode[y.value];if(I){const{value:Y}=a;return Y.has(V)}else return z===V}),labelField:d,renderLabel:f,renderOption:g,handleMouseMove:G,handleMouseEnter:A,handleClick:p}},render(){const{clsPrefix:e,tmNode:{rawNode:n},isSelected:o,isPending:l,isGrouped:a,showCheckmark:f,nodeProps:g,renderOption:d,renderLabel:y,handleClick:w,handleMouseEnter:T,handleMouseMove:S}=this,_=Wn(o,e),O=y?[y(n,o),f&&_]:[Te(n[this.labelField],n,o),f&&_],p=g==null?void 0:g(n),A=c("div",Object.assign({},p,{class:[`${e}-base-select-option`,n.class,p==null?void 0:p.class,{[`${e}-base-select-option--disabled`]:n.disabled,[`${e}-base-select-option--selected`]:o,[`${e}-base-select-option--grouped`]:a,[`${e}-base-select-option--pending`]:l,[`${e}-base-select-option--show-checkmark`]:f}],style:[(p==null?void 0:p.style)||"",n.style||""],onClick:tt([w,p==null?void 0:p.onClick]),onMouseenter:tt([T,p==null?void 0:p.onMouseenter]),onMousemove:tt([S,p==null?void 0:p.onMousemove])}),c("div",{class:`${e}-base-select-option__content`},O));return n.render?n.render({node:A,option:n,selected:o}):d?d({node:A,option:n,selected:o}):A}}),jn=k("base-select-menu",`
 line-height: 1.5;
 outline: none;
 z-index: 0;
 position: relative;
