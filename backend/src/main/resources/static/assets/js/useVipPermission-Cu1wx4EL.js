var g=(s,t,o)=>new Promise((c,r)=>{var l=a=>{try{n(o.next(a))}catch(i){r(i)}},d=a=>{try{n(o.throw(a))}catch(i){r(i)}},n=a=>a.done?c(a.value):Promise.resolve(a.value).then(l,d);n((o=o.apply(s,t)).next())});import{u as w,aw as y,p as P,ax as Q}from"./index-DahIAh76.js";import{r as T,c as u}from"./vue-core-k66yWm0l.js";const{message:p,dialog:f}=y(["message","dialog"],{configProviderProps:{theme:Q}});function x(){const s=w(),t=T({dailyQuota:5,usedToday:0,remainingToday:5,usagePercent:0,dailyTutorQuota:200,tutorUsedToday:0,tutorRemainingToday:200,tutorUsagePercent:0,isVip:!1,vipLevel:0}),o=u(()=>s.isVip()),c=u(()=>({0:"普通用户",1:"月度会员",2:"季度会员",3:"年度会员"})[s.vipLevel]||"普通用户"),r=()=>g(null,null,function*(){try{const e=yield P.get("/user/quota");if(e.code===200)return t.value=e.data,e.data}catch(e){console.error("获取配额信息失败:",e)}}),l=(e,v=1)=>o.value?!0:(n(e),!1),d=(e=1)=>g(null,null,function*(){return yield r(),t.value.remainingToday<e?(t.value.isVip?p.warning(`今日AI调用次数已用完 (${t.value.usedToday}/${t.value.dailyQuota})，请明天再试`):f.warning({title:"免费额度已用完",content:`您今日的免费额度已用完 (${t.value.usedToday}/${t.value.dailyQuota})。升级 VIP 可获得每日 50-200 次额度！`,positiveText:"立即升级",negativeText:"取消",onPositiveClick:()=>{window.location.href="/pricing"}}),!1):!0}),n=(e="AI 生成")=>{f.warning({title:"VIP 专属功能",content:`【${e}】是 VIP 专属功能。升级 VIP 即可解锁所有 AI 增强功能，享受智能学习体验！
