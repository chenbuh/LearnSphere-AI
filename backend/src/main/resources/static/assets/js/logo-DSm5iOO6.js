...
`,[I("absolute-positioned",`
 ...
 `)]),Q("disabled",[Q("selected, child-active",[s("&:focus-within",Ae)]),I("selected",[G(null,[b("icon","color: var(--n-item-icon-color-active-hover-horizontal);"),m("menu-item-content-header",`
 ...
 `,[s("a","color: var(--n-item-text-color-child-active-hover-horizontal);"),b("extra","color: var(--n-item-text-color-child-active-hover-horizontal);")])])]),G("border-bottom: 2px solid var(--n-border-color-horizontal);",Ae)]),m("menu-item-content-header",[s("a","color: var(--n-item-text-color-horizontal);")])])]),Q("responsive",[m("menu-item-content-header",`
 overflow: hidden;
 ...
 `)]),Q("disabled",[Q("selected, child-active",[s("&:focus-within",ke)]),I("selected",[G(null,[b("arrow","color: var(--n-arrow-color-active-hover);"),b("icon","color: var(--n-item-icon-color-active-hover);"),m("menu-item-content-header",`
 ...
 `,[s("a","color: var(--n-item-text-color-child-active-hover);"),b("extra","color: var(--n-item-text-color-child-active-hover);")])])]),I("selected",[G(null,[s("&::before","background-color: var(--n-item-color-active-hover);")])]),G(null,ke)]),b("icon",`
 grid-area: icon;
