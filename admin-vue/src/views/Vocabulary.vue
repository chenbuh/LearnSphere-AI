...
import { NCard, NDataTable, NButton, NInput, NPagination, NSelect, NModal, NForm, NFormItem, NPopconfirm, useMessage, NSpace, NTabs, NTabPane } from 'naive-ui'
import { Search, Plus, Edit, Trash, Sparkles } from 'lucide-vue-next'
...
const handleAiFill = async () => {
  ...
  try {
    const res = await adminApi.generateVocabularyDetails(formData.value.id)
    if (res.code === 200) {
