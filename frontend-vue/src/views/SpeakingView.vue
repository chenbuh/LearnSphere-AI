...
import { 
  ...
  NGrid, NGridItem, NDivider, NList, NListItem, NThing, NIcon, NSpin
} from 'naive-ui'
import {
  Mic, PlayCircle, StopCircle, Volume2, Languages, RotateCcw,
  MessageCircle, BarChart, CheckCircle2, User, Bot, AlertTriangle
        ...
        <n-grid x-gap="24" cols="1 800:2" responsive="screen">
            <n-grid-item>
                <n-card class="topic-card" title="Speaking Topic" :bordered="false">
                    <h2 class="text-xl font-bold mb-4 text-white">{{ topicData.title }}</h2>
                    ...
                    <div class="tips-section">
                        ...
                        <n-space>
                            ...
                            <n-tag v-for="t in topicData.tips" :key="t" size="small" :bordered="false" type="warning">{{ t }}</n-tag>
                        </n-space>
                    </div>
                </n-card>
            </n-grid-item>
