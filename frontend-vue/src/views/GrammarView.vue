...
import { 
  ...
  NGrid, NGridItem, NSpace, NDivider, NList, NListItem, NThing, useMessage
} from 'naive-ui'
import { 
  Clock, Link, MapPin, FileText, Drama, Stamp, Zap, BookOpen, 
  Target, Rocket, CheckCircle2, XCircle, Trophy, RotateCcw, 
  ArrowLeft, Settings, BarChart3, HelpCircle 
...
const selectedTopic = ref(grammarTopics[0].id)
...
const userAnswers = ref([]) // Track user answers per question
const score = ref(0)
...
const submitPractice = async () => {
    ...
    message.success('批改完成，分数：' + Math.round((correctCount / totalQuestions.value) * 100) + '%')
}
  ...
  <div class="page-container">
    <div class="main-layout">
        ...
        <div class="content-panel">
            ...
            <div v-if="!isStarted" class="topics-grid-container">
            ...
            <div v-else-if="!showResult" class="question-container">
                <n-card class="question-box" :bordered="false" size="huge">
                    <!-- Progress -->
            ...
            <div v-else class="result-container">
                <n-card class="result-card" :bordered="false">
                     <div class="result-icon-wrapper">
                        <n-icon :component="Trophy" size="100" color="#eab308" />
                     </div>
                     <h2 class="result-title">练习完成!</h2>
                     <p class="result-subtitle">语法掌握度稳步提升中</p>
